...
# between 1981 and 1979
# Did = (1981_value_treat - 1979_value_treat) - (1981_value_ctrl = 1979_value_ctrl)
# years = 1981, 1979
# value = Hispanics
# treat = in Miami, after Mariel
# control = other cities
...
```
**ANS:** The average treatment effect, standardized for changes over time using the difference-in-difference estimator, is 287.9 pesos. This indicates that, on average, households that underwent treatment saw an increase of 287.9 pesos in their value of animal holdings (`vani`).
